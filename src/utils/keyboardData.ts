...
export const JAMO_TO_KEY: Record<string, { key: string; shift?: boolean; hand: 'left' | 'right' }> = {
  'ㅂ': { key: 'q', hand: 'left' }, 'ㅃ': { key: 'q', shift: true, hand: 'left' },
  'ㅈ': { key: 'w', hand: 'left' }, 'ㅉ': { key: 'w', shift: true, hand: 'left' },
  'ㄷ': { key: 'e', hand: 'left' }, 'ㄸ': { key: 'e', shift: true, hand: 'left' },
  'ㄱ': { key: 'r', hand: 'left' }, 'ㄲ': { key: 'r', shift: true, hand: 'left' },
  'ㅅ': { key: 't', hand: 'left' }, 'ㅆ': { key: 't', shift: true, hand: 'left' },
  'ㅛ': { key: 'y', hand: 'right' },
  'ㅕ': { key: 'u', hand: 'right' },
  'ㅑ': { key: 'i', hand: 'right' },
  'ㅐ': { key: 'o', hand: 'right' }, 'ㅒ': { key: 'o', shift: true, hand: 'right' },
  'ㅔ': { key: 'p', hand: 'right' }, 'ㅖ': { key: 'p', shift: true, hand: 'right' },
  'ㅁ': { key: 'a', hand: 'left' },
  'ㄴ': { key: 's', hand: 'left' },
  'ㅇ': { key: 'd', hand: 'left' },
  'ㄹ': { key: 'f', hand: 'left' },
