...
- **Contextual Learning**:
  ...
  - Displays English translations for words, sentences, and proverbs.
...
1. **[NIIED (National Institute for International Education)](https://www.niied.go.kr/) — [Official TOPIK Study & Exam Resource Center](https://www.topik.go.kr/GBIP/GBIPMNG021.do)**:
   ...
   - **TOPIK II (Intermediate Level 3 & 4):** Official vocabulary covering work, technology, society, economics, emotions, and academic topics.
...
3. **[King Sejong Institute Foundation (세종학당재단)](https://www.kingsejong.org/) — [Nuri-Sejonghakdang Standard Textbooks & Learning Materials](https://nuri.sejonghakdang.org/mode/board/B200000.do)**:
   - Practical situational conversation modules (ordering food at cafes/restaurants, taking the subway, asking for directions, shopping, hospital/pharmacy symptoms).
